                    ...
                    >
                      <div className="flex items-center gap-12">
                        <div className="text-center min-w-[80px]">
                          {/* 1. DATE DISPLAY: Added the date of the booking above the time */}
                          <p className="text-[10px] font-black text-rose-300 uppercase tracking-widest mb-1">
                            {format(parseISO(apt.scheduled_at), "MMM dd")}
                          </p>

                          {/* 2. TIME DISPLAY: Added timeZone: 'UTC' to stop the 10:30PM error */}
                          <p className="text-2xl font-light text-slate-800 tracking-tighter">
                            {new Date(apt.scheduled_at).toLocaleTimeString(
                              "en-US",
                              {
                                hour: "2-digit",
                                minute: "2-digit",
                                hour12: false, // Using 24h format as seen in your schedule
                                timeZone: "UTC", // This forces it to match your database exactly
                              },
                            )}
                          </p>
