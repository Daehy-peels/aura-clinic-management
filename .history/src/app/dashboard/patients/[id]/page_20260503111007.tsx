        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-10">
                ...
                <div className="bg-rose-50/30 rounded-2xl md:rounded-3xl p-6 md:p-8 border border-rose-100/50">
                  <p className="text-slate-600 leading-relaxed font-serif italic text-base md:text-lg">
                    ...
                    {patient.medical_history ||
                      "The patient's clinical history is currently clear."}
                    "
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4">
                {appointments.length === 0 ? (
                  ...
                  appointments.map((apt) => (
                    <ActivityCard key={apt.id} apt={apt} />
                  ))
                )}
              </div>
            )}
          ...
          <div className="lg:col-span-4 space-y-6 md:space-y-8">
            <div className="bg-slate-900 rounded-[2rem] md:rounded-[2.5rem] p-8 md:p-10 text-white relative overflow-hidden group">
              ...
              <h4 className="text-[8px] md:text-[9px] font-black text-rose-400 uppercase tracking-[0.4em] mb-4 md:mb-6 relative z-10">
                Care Notes
              </h4>
            ...
            <div className="bg-rose-50/50 border border-rose-100 rounded-[2rem] p-8 md:p-10">
              <h4 className="text-[8px] md:text-[9px] font-black text-rose-400 uppercase tracking-[0.4em] mb-4">
                Patient Integrity
              </h4>
              ...
              <p className="text-[9px] text-slate-400 leading-tight">
                Data encrypted per medical standards.
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="bg-white p-5 md:p-8 rounded-2xl md:rounded-3xl border border-slate-100 flex items-center justify-between group hover:border-rose-200 transition-all">
      <div className="flex gap-4 md:gap-8 items-center">
        <div className="text-center min-w-[50px]">
          ...
          <p className="text-[8px] md:text-[9px] font-black text-rose-400 uppercase">
      ...
      <span
        className={`text-[7px] md:text-[8px] font-black uppercase px-2 md:px-3 py-1 rounded-full ${apt.status === "completed" ? "bg-emerald-50 text-emerald-600" : "bg-amber-50 text-amber-600"}`}
      >
        {apt.status}
      </span>
    </div>
...
function EmptyState() {
  return (
    <div className="text-center py-16 md:py-20 bg-white rounded-[2rem] border border-dashed border-slate-200">
      <p className="font-serif italic text-slate-400 text-base md:text-lg">
