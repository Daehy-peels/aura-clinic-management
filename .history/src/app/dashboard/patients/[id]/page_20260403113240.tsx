        ...
        <div className="mb-12 flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          <div className="flex items-center gap-8">
            ...
            <div>
              <Link
                ...
                className="text-[10px] font-bold uppercase tracking-[0.3em] text-rose-400 hover:text-rose-600 transition-colors block mb-2"
              >
                ← Return to Directory
              </Link>
          ...
          <div className="flex gap-4">
            <Link
              ...
              className="px-8 py-3 bg-white border border-rose-100 text-gray-500 text-[10px] font-bold uppercase tracking-widest rounded-full hover:bg-rose-50 transition-all shadow-sm"
            >
              Edit Profile
            </Link>
            <Link
              href="/dashboard/appointments/new"
              className="px-8 py-3 bg-rose-500 text-white text-[10px] font-bold uppercase tracking-widest rounded-full hover:bg-rose-600 hover:shadow-lg hover:shadow-rose-200 transition-all shadow-sm"
            >
              Book Session
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-[2.5rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-rose-100 relative overflow-hidden">
              ...
              <h3 className="text-[10px] font-bold text-rose-400 uppercase tracking-widest mb-8 relative">
                Patient Identity
              </h3>
          ...
          <div className="lg:col-span-8 space-y-8">
              ...
              <div className="p-8 bg-rose-50/20 rounded-[2rem] border border-rose-50/50 min-h-[150px]">
                <p className="text-gray-600 leading-relaxed font-light italic">
                  {patient.medical_history ||
                    "No prior clinical notes recorded. Documentation is advised for new treatments."}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-[2.5rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-rose-100">
              <h3 className="text-[10px] font-bold text-rose-400 uppercase tracking-widest mb-8">
                Treatment Activity
              </h3>
              ...
              {appointments.length === 0 ? (
                ...
                <div className="space-y-4">
                  {appointments.map((apt) => (
                    <div
                      key={apt.id}
                      className="flex items-center justify-between p-6 bg-white border border-rose-50 rounded-2xl group hover:shadow-md transition-all"
                    >
                      <div>
                      ...
                      <div className="flex items-center gap-4">
                        <span
                          className={`text-[8px] font-black uppercase tracking-[0.2em] px-3 py-1 rounded-full ${apt.status === "completed" ? "bg-emerald-50 text-emerald-500" : "bg-rose-50 text-rose-400"}`}
                        >
                          {apt.status}
                        </span>
                        <Link
