        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-white/80 backdrop-blur-sm rounded-[2rem] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-rose-100">
              <h2 className="text-xs font-bold text-rose-400 uppercase tracking-[0.2em] mb-6">
                Patient Essentials
              </h2>
              ...
              <div className="prose prose-rose max-w-none">
                <p className="text-gray-600 leading-relaxed font-light italic bg-rose-50/30 p-6 rounded-3xl border border-rose-50">
                  {patient.medical_history ||
                    "No medical history recorded for this patient yet. Use the edit profile button to add clinical documentation."}
                </p>
              </div>
              ...
              <div className="mt-12">
                ...
                <div className="border border-dashed border-rose-200 rounded-3xl p-8 text-center">
                  ...
                  <Link
                    ...
                    className="inline-block mt-4 text-[10px] font-bold uppercase tracking-widest text-rose-500 hover:underline"
                  >
                    Schedule Treatment →
                  </Link>
                </div>
