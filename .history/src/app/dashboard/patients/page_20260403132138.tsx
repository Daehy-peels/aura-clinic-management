      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-12 gap-8">
          <div className="space-y-2">
            ...
            <p className="text-gray-400 font-light italic">Refining the search for clinical excellence.</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <div className="relative group w-full sm:w-72">
              ...
              />
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 absolute left-4 top-3 text-rose-300 group-hover:text-rose-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Directory Content */}
        {loading ? (
          <div className="flex justify-center py-20 animate-pulse text-rose-300 font-serif italic text-2xl">Consulting records...</div>
        ) : filteredPatients.length === 0 ? (
          <div className="bg-white/60 backdrop-blur-sm border border-dashed border-rose-200 rounded-[3rem] p-24 text-center">
            <p className="text-gray-400 font-light italic text-lg">No clinical records found matching "{searchTerm}"</p>
            <button onClick={() => setSearchTerm("")} className="text-rose-500 font-bold text-[10px] uppercase tracking-widest mt-4 hover:underline">Clear Search</button>
          </div>
        ) : (
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-rose-50 bg-rose-50/20">
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-rose-400">Patient Profile</th>
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-rose-400">Digital Contact</th>
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-rose-400">Enrollment Date</th>
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-rose-400 text-right">Action</th>
                </tr>
              </thead>
