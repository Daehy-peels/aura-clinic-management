      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-10 text-center md:text-left">
          ...
          <p className="text-gray-400 mt-2 font-light">
            Enter details below to create a new clinical profile.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-rose-100">
            <h2 className="text-sm font-semibold text-rose-400 uppercase tracking-widest mb-8">
              Basic Profile
            </h2>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-rose-100">
            <h2 className="text-sm font-semibold text-rose-400 uppercase tracking-widest mb-6">
              Clinical History
            </h2>
            <textarea
