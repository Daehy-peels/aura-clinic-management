            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-rose-50">
                  <th className="px-8 py-6 text-xs font-bold uppercase tracking-widest text-rose-400">
                    Patient Details
                  </th>
                  <th className="px-8 py-6 text-xs font-bold uppercase tracking-widest text-rose-400">
                    Contact Info
                  ...
                  <th className="px-8 py-6 text-xs font-bold uppercase tracking-widest text-rose-400 text-right">
                    Actions
                  </th>
                </tr>
              </thead>
