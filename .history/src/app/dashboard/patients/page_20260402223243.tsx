        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            ...
            <p className="text-gray-400 mt-2 font-light">
              Manage and review your clinic's patient records.
            </p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-rose-50">
                  ...
                  <th className="px-8 py-6 text-xs font-bold uppercase tracking-widest text-rose-400 text-right">Actions</th>
                </tr>
              </thead>
                  ...
                  <tr key={patient.id} className="group hover:bg-rose-50/30 transition-colors">
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-sm font-semibold text-gray-700">{patient.first_name} {patient.last_name}</p>
                          <p className="text-[10px] text-gray-400 uppercase tracking-tighter mt-1 font-bold">#{patient.id.slice(0, 8)}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-8 py-6 text-sm text-gray-600">{patient.email}</td>
                    ...
                    <td className="px-8 py-6 text-right space-x-2">
                      <Link
                        ...
                        className="inline-block px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-gray-400 border border-gray-200 rounded-full hover:border-rose-300 hover:text-rose-500 transition-all"
                      >
                        View
                      </Link>
                      {/* --- DELETE BUTTON --- */}
                      <button
                        ...
                        className="px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-red-300 border border-red-50 rounded-full hover:bg-red-50 hover:text-red-500 transition-all"
                      >
                        Delete
                      </button>
                    </td>
