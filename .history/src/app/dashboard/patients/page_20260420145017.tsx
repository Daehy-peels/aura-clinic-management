      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="animate-in fade-in slide-in-from-left duration-700">
            ...
            >
              <span className="group-hover:-translate-x-1 transition-transform">←</span> Back to Dossier
            </Link>
            <h1 className="text-5xl font-light text-slate-900 mt-4 tracking-tighter">
              Refine <span className="font-serif italic text-rose-500">Patient File</span>
            </h1>
          </div>
          <div className="hidden md:block text-right">
             <p className="text-[9px] font-black text-rose-300 uppercase tracking-widest">Database Sync</p>
             <p className="text-xs text-slate-400 italic">ID: {String(id).slice(0, 8)}</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <div className="bg-white rounded-[3rem] p-10 md:p-14 border border-slate-100 shadow-[0_20px_60px_rgba(0,0,0,0.02)] relative overflow-hidden group">
            ...
            <div className="flex items-center gap-4 mb-12">
               <h2 className="text-[10px] font-black text-rose-400 uppercase tracking-[0.4em]">Primary Identity</h2>
          ...
          <div className="bg-white rounded-[3rem] p-10 md:p-14 border border-slate-100 shadow-[0_20px_60px_rgba(0,0,0,0.02)]">
            <div className="flex items-center gap-4 mb-8">
               <h2 className="text-[10px] font-black text-rose-400 uppercase tracking-[0.4em]">Clinical Notes</h2>
               <div className="h-px flex-1 bg-rose-50" />
            </div>
            
            <p className="text-[10px] text-slate-400 mb-6 italic">Record any known allergies, current medications, or skin sensitivities below.</p>
