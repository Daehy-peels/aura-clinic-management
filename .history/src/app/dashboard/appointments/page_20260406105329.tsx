...
export default function AppointmentsPage() {
  ...
  const handleDelete = async (id: string) => {
    const confirmed = window.confirm("Are you sure you want to remove this appointment? This action cannot be undone.");
                    ...
                    {!isCancelled && (
                      <button
                        ...
                        className={`p-4 rounded-2xl transition-all active:scale-90 ${
                          isCompleted ? "bg-emerald-500 text-white" : "bg-rose-50 text-rose-300 hover:bg-emerald-500 hover:text-white"
                        }`}
