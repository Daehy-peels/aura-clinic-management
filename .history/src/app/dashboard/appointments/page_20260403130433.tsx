              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center border-r border-gray-100 pr-8 min-w-[120px]">
                    <p
                      className={`text-2xl font-light ${isCancelled ? "text-gray-400" : "text-gray-800"}`}
                    >
                    ...
                    <p
                      className={`text-[10px] font-bold uppercase tracking-widest mt-1 ${accentText}`}
                    >
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <div className="flex items-center justify-center md:justify-start gap-3">
                      <h3
                        className={`text-sm font-bold uppercase tracking-wider ${isCancelled ? "text-gray-400 line-through" : isCompleted ? "text-emerald-900/40" : "text-gray-700"}`}
                      >
                        {apt.patients?.first_name} {apt.patients?.last_name}
                      </h3>
                      {isCancelled && (
                        <span className="text-[8px] font-black bg-gray-200 text-gray-500 px-2 py-0.5 rounded uppercase tracking-tighter">
                          Void
                        </span>
                      )}
                    </div>
                    <p
                      className={`text-lg font-serif italic mt-1 ${isCompleted ? "text-emerald-600" : isCancelled ? "text-gray-400" : "text-rose-500"}`}
                    >
                      {apt.treatment_type}
                    </p>
                  </div>
