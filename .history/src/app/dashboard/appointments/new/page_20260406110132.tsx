...
export default function BookAppointmentPage() {
  ...
  useEffect(() => {
    async function checkOverlap() {
      ...
      if (data) {
        setSlotError(
          `Overlap detected with ${data.patients?.first_name}'s appointment.`,
        );
      }
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-10">
          <Link
            ...
            className="text-[10px] font-black uppercase tracking-widest text-rose-300 hover:text-rose-500 transition-all"
          >
            ← View Schedule
          </Link>
        ...
        <form
          ...
          className="bg-white/80 backdrop-blur-xl p-12 rounded-[3.5rem] shadow-2xl shadow-rose-100/50 border border-white space-y-10"
        >
          {/* Patient & Treatment */}
