...
export default function BookAppointmentPage() {
  ...
  useEffect(() => {
    ...
    if (conflict) {
      setSlotError(
        `Slot occupied by ${conflict.patients?.first_name || "another patient"}.`,
      );
    } else {
      setSlotError(null);
    }
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5">
          ...
          <form
            ...
            className="bg-white p-8 rounded-3xl shadow-xl border border-slate-100 space-y-5"
          >
            {/* Patient Select */}
            <div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-6">
                      <span
                        className={`text-[11px] font-black w-10 ${isOccupied ? "text-slate-300" : isSelected ? "text-white" : "text-slate-400"}`}
                      >
                        {slot.time}
                      </span>
                      <div className="text-left">
                        {isOccupied ? (
                          ...
                          <span
                            className={`text-[10px] font-bold uppercase tracking-widest ${isSelected ? "text-white" : "text-[#00C389]"}`}
                          >
                    ...
                    <div
                      className={`text-[12px] ${isOccupied ? "text-slate-300" : isSelected ? "text-white" : "text-emerald-300"}`}
                    >
