      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            ...
            <p className="text-gray-400 mt-2 font-light italic">Managing today's aesthetic transformations.</p>
          </div>
        ...
        {loading ? (
          <div className="flex justify-center py-20">
            <div className="animate-pulse text-rose-300 font-serif italic text-xl">Reviewing the calendar...</div>
          </div>
        ) : appointments.length === 0 ? (
          <div className="bg-white/60 backdrop-blur-sm border border-rose-100 rounded-[3rem] p-20 text-center">
            <p className="text-gray-400 font-light text-lg">No treatments scheduled for today.</p>
            <Link href="/dashboard/appointments/new" className="text-rose-500 font-bold text-sm uppercase tracking-widest mt-4 block hover:underline">
          ...
          <div className="space-y-4">
            {appointments.map((apt) => {
              ...
              return (
                <div key={apt.id} className="group bg-white/80 backdrop-blur-sm rounded-[2rem] p-6 border border-rose-100 shadow-[0_4px_20px_rgb(0,0,0,0.02)] flex flex-col md:flex-row items-center justify-between gap-6 hover:shadow-rose-100 transition-all">
