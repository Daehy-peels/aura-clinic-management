...
export default function EditAppointmentPage() {
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-[#FFF5F5] flex items-center justify-center font-serif text-rose-400">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-5xl font-light mt-4 tracking-tight">
            Edit <span className="font-serif italic text-rose-500">Record</span>
          </h1>
        ...
        >
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full py-5 bg-rose-500 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-full shadow-xl shadow-rose-100 hover:bg-rose-600 active:scale-95 transition-all disabled:opacity-50"
            >
              ...
              <div className="flex items-center justify-between mb-10">
                <div>
                  ...
                  <p className="text-[9px] text-gray-400 italic mt-1">
                    Hover over "Taken" slots to see details
                  </p>
                </div>
                <input
                  type="date"
                ...
                {timeSlots.map((time) => {
                  ...
                  return (
                    ...
                    >
                      {time}
                      {isOccupied && (
                        <span className="block text-[7px] mt-1 uppercase opacity-50">
                          Taken
                        </span>
                      )}
                    </button>
