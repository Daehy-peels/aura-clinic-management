  ...
  useEffect(() => {
    async function fetchAppointment() {
      ...
      if (data) {
        ...
        const cleanDate = data.scheduled_at
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12 text-center md:text-left">
          <Link
            ...
            className="group inline-flex items-center text-[10px] font-black uppercase tracking-[0.2em] text-rose-300 hover:text-rose-500 transition-all"
          >
          ...
          <p className="text-gray-400 mt-2 font-light italic">
            Updating treatment for{" "}
            <span className="font-bold text-rose-400 not-italic uppercase tracking-widest text-[11px] ml-1">
              {patientName}
            </span>
          </p>
        </div>
