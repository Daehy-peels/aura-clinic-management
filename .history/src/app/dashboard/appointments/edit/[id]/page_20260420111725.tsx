  ...
  useEffect(() => {
    ...
    async function fetchDaySchedule() {
      const { data } = await supabase
        .from("appointments")
        .select(
          `id, scheduled_at, treatment_type, patients (first_name, last_name)`,
        )
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
          <div>
            <Link
              ...
              className="group text-[10px] font-black uppercase tracking-[0.3em] text-rose-300 hover:text-rose-600 transition-all flex items-center"
            >
        ...
        >
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full py-6 bg-rose-500 text-white text-[10px] font-black uppercase tracking-[0.3em] rounded-full shadow-xl shadow-rose-100 hover:bg-rose-600 active:scale-[0.98] transition-all disabled:opacity-50"
            >
            ...
            <div className="bg-white p-10 rounded-[3.5rem] border border-slate-100 shadow-[0_10px_40px_rgba(0,0,0,0.02)]">
              <div className="flex items-center justify-between mb-10">
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1">
                    Duration: {TREATMENTS[formData.treatment_type] || 30}{" "}
                    Minutes
                  </p>
                </div>
                <input
              ...
              <div className="mt-10 pt-10 border-t border-slate-50 flex flex-wrap gap-6 justify-center text-[9px] font-black uppercase tracking-widest text-slate-400">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-rose-500" /> Selected
                  Block
                </div>
                <div className="flex items-center gap-2">
