...
export default function EditAppointmentPage() {
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-[#FFFDFD] flex items-center justify-center font-serif text-rose-500 italic">
        Syncing clinical files...
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-10">
          <Link
            ...
            className="text-[10px] font-black uppercase tracking-[0.3em] text-rose-400 hover:text-rose-600 transition-all"
          >
            ← Return to Schedule
          </Link>
        ...
        >
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full py-6 bg-rose-500 text-white text-[11px] font-black uppercase tracking-[0.3em] rounded-full shadow-xl shadow-rose-100 hover:bg-rose-600 transition-all active:scale-95"
            >
