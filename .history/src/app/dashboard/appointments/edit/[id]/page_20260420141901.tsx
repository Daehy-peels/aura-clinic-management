      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-12 flex justify-between items-end">
          <div>
            ...
            <h1 className="text-6xl font-light tracking-tighter mt-2 text-slate-800">
              Edit{" "}
        ...
        >
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <button className="w-full py-6 bg-rose-500 text-white font-black uppercase tracking-widest rounded-full shadow-lg hover:bg-rose-600 transition-all">
              Update Session
            </button>
          </div>
