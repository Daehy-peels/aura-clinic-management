      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-10 flex justify-between items-end">
          <div>
            ...
            <h1 className="text-4xl font-light mt-2">
              Adjust{" "}
              <span className="font-serif italic text-rose-500">Duration</span>
            </h1>
            <p className="text-gray-400 text-[10px] uppercase tracking-widest font-bold mt-1">
              {patientName} • {getDuration(formData.treatment_type)} Mins
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full py-5 bg-rose-500 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-full"
            >
              Update Record
            </button>
          </div>
            ...
            <div className="bg-white/70 backdrop-blur-xl p-8 rounded-[3.5rem] border border-white shadow-sm">
              <div className="flex items-center justify-between mb-8">
                ...
                <input
                  ...
                  className="bg-rose-50 text-rose-500 text-xs font-bold p-2 rounded-lg"
                />
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      {!isOccupied && hasConflict && (
                        <span className="block text-[7px] text-orange-400">
                          Overlap
                        </span>
                      )}
                    </button>
