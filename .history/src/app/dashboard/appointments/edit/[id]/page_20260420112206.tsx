...
export default function EditAppointmentPage() {
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-[#FFF5F5] flex items-center justify-center font-serif text-rose-400 italic">
        ...
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <Link
              ...
              className="text-[10px] font-black uppercase tracking-[0.3em] text-rose-300 hover:text-rose-500 transition-all"
            >
              ← Back to Schedule
            </Link>
            <h1 className="text-5xl font-light mt-4 tracking-tighter">
              Edit{" "}
        ...
        >
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-white p-8 rounded-[3rem] border border-slate-100 shadow-sm space-y-8">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[9px] text-slate-400 italic ml-1">
                  *Blocks will update on the timeline below
                </p>
              </div>
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full py-6 bg-rose-500 text-white text-[10px] font-black uppercase tracking-[0.3em] rounded-full shadow-xl shadow-rose-100 hover:bg-rose-600 transition-all active:scale-95"
            >
