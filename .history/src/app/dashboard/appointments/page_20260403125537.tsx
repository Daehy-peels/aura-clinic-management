          ...
          <div className="space-y-4">
            {appointments.map((apt) => {
              ...
              return (
                <div
                  key={apt.id}
                  className={`group transition-all duration-500 rounded-[2rem] p-6 border flex flex-col md:flex-row items-center justify-between gap-6 ${
                    isCompleted
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center border-r border-gray-100 pr-8 min-w-[120px]">
                    <p
                      className={`text-2xl font-light ${isCompleted ? "text-emerald-700" : "text-gray-800"}`}
                    >
                    ...
                    <p
                      className={`text-[10px] font-bold uppercase tracking-widest mt-1 ${isCompleted ? "text-emerald-400" : "text-rose-400"}`}
                    >
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h3
                      className={`text-sm font-bold uppercase tracking-wider ${isCompleted ? "text-emerald-900/40 line-through" : "text-gray-700"}`}
                    >
                      {apt.patients?.first_name} {apt.patients?.last_name}
                    </h3>
                    <p
                      className={`text-lg font-serif italic mt-1 ${isCompleted ? "text-emerald-600" : "text-rose-500"}`}
                    >
                      {apt.treatment_type}
                    </p>
                  </div>
